...
export function useStationaryDraggableXrPanel({ groupRef, gl, camera, layout, panelWorldAnchorRef, }: {
    ...
    useEffect(() => {
        ...
        const onSqueezeStart0 = (() => onDragStartByIndex(0)) as unknown as (event: {
            data: XRInputSource;
        }) => void;
        const onSqueezeEnd0 = (() => onDragEndByIndex(0)) as unknown as (event: {
            data: XRInputSource;
        }) => void;
        const onSqueezeStart1 = (() => onDragStartByIndex(1)) as unknown as (event: {
            data: XRInputSource;
        }) => void;
        const onSqueezeEnd1 = (() => onDragEndByIndex(1)) as unknown as (event: {
            data: XRInputSource;
        }) => void;
