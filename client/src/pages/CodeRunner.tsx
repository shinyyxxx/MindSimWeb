      ...
      <div className="cr-layout">
        <section className="cr-editor-panel">
          ...
          <div className="cr-editor-wrap">
            ...
            <textarea className="cr-textarea" value={code} onChange={(e) => setCode(e.target.value)} onKeyDown={handleKeyDown} spellCheck={false} placeholder="x = Mind()&#10;x.name = &quot;my mind&quot;"/>
          </div>
        ...
        <section className="cr-result-panel">
          {!result && !error && !loading && (<div className="cr-empty">
              <div className="cr-empty-icon">&#9654;</div>
              <p>Run your code to see results here</p>
            </div>)}

          {loading && (<div className="cr-empty">
              <div className="cr-spinner"/>
              <p>Executing...</p>
            </div>)}

          {error && (<div className="cr-error-box">
              <strong>Error</strong>
              <p>{error}</p>
            </div>)}
          ...
          {result && (<>
              ...
              {result.execution_log.length > 0 && (<div className="cr-section">
                  <h3 className="cr-section-title">Execution Log</h3>
                  <div className="cr-log">
                    {result.execution_log.map((entry, i) => (<div key={i} className="cr-log-entry">
              ...
              {result.created_minds.length > 0 && (<div className="cr-section">
                  <h3 className="cr-section-title">Created Minds</h3>
                  <div className="cr-cards">
                    {result.created_minds.map((mind) => (<div key={mind.id} className="cr-card" style={{ borderLeftColor: mind.color }}>
                        ...
                        <div className="cr-card-meta">
                          ...
                          {mind.mental_sphere_ids.length > 0 && (<span>mentals: [{mind.mental_sphere_ids.join(', ')}]</span>)}
                        </div>
                      </div>))}
                  </div>
                </div>)}

              {result.created_mentals.length > 0 && (<div className="cr-section">
                  <h3 className="cr-section-title">Created Mentals</h3>
                  <div className="cr-cards">
                    {result.created_mentals.map((mental) => (<div key={mental.id} className="cr-card" style={{ borderLeftColor: mental.color }}>
                        <div className="cr-card-head">
