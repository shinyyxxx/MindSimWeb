...
export function XRProfilePanel({
  ...
  return (
    <group ref={groupRef}>
      ...
      {profile.labelNumber && (
        <Text position={[0.04, -0.22, 0.006]} anchorX="left" anchorY="middle" fontSize={0.045} color="#0f172a">
      ...
      {attrs.length > 1 && (
        <Text position={[0.04, -0.39, 0.006]} anchorX="left" anchorY="middle" fontSize={0.028} color="#334155">
          {`+${attrs.length - 1} more`}
        </Text>
      )}
